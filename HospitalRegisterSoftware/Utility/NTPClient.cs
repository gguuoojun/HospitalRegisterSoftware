...
namespace Utility
{
	public class NTPClient
	{
			...
			get
			{
				...
				case _Stratum.SecondaryReference:
				{
					...
					case 3:
					{
						...
						try
						{
							IPHostEntry hostByAddress = Dns.GetHostEntry(text2);
					...
					DateTime d = this.ComputeDate(this.GetMilliSeconds(offReferenceTimestamp));
		...
		public DateTime ReceiveTimestamp
		{
			get
			{
				DateTime d = this.ComputeDate(this.GetMilliSeconds(32));
				TimeSpan utcOffset = TimeZone.CurrentTimeZone.GetUtcOffset(DateTime.Now);
				return d + utcOffset;
			}
		}
		...
		public DateTime TransmitTimestamp
		{
			get
			{
				DateTime d = this.ComputeDate(this.GetMilliSeconds(40));
				TimeSpan utcOffset = TimeZone.CurrentTimeZone.GetUtcOffset(DateTime.Now);
				return d + utcOffset;
			}
			set
		...
		public void Connect()
		{
			try
			{
				IPHostEntry hostEntry = Dns.GetHostEntry(this.TimeServer);
		...
		public bool SetTime(DateTime trts)
		{
